...
$pkg_cmd -y remove gcc cpp make perl \
                   glibc-devel glibc-headers elfutils-libelf-devel \
                   kernel-devel kernel-headers kernel-firmware libmpc linux-firmware
...
# Restore centos default repo settings
...
# Remove yum history and cache
rm -rf /var/cache/yum/* /var/lib/yum/* /var/cache/dnf/* /var/lib/dnf/*
